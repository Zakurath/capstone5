...
def run_pipeline():
    ...
    try:
        ...
        # Step 6: Fetch Hacker News AI-related stories
    try:
        print("[6/7] Fetching Hacker News AI-related stories...")
        hacker_news_ingest.main()
        print("Hacker News update complete.\n")
    except Exception as e:
        print(f"Error updating Hacker News data: {e}\n")
