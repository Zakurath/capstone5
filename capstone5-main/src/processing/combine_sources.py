...
THE_HACKER_NEWS_FILE = BASE_DIR / "data" / "the_hacker_news_data.json"
...
def main() -> None:
    ...
    # Load The Hacker News articles
    the_hacker_news_records = load_json(THE_HACKER_NEWS_FILE)
    all_records.extend(the_hacker_news_records)
    print(f"Loaded {len(the_hacker_news_records)} The Hacker News records.")
